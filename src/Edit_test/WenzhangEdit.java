...
public class WenzhangEdit implements TestInfo {
...
//		  while(true){
//			  if(isTextPresent("取消置顶")==true){
//				  driver.findElement(By.linkText("取消置顶")).click();
...
//		  Thread.sleep(1000);
		try {
			...
			driver.findElement(By.xpath("(//a[contains(text(),'删除')])[1]")).click();//删除第一个出现的文章，这个有点瑕疵，如果有置顶的文章，这块就会删错了，应该取消所有置顶的文章
			// TODO: handle exception
		}
		  driver.findElement(By.linkText("确定")).click();
	      //driver.findElement(By.xpath("//a[contains(@value,'1')]")).click(); //我发起的文章，删除刚刚发的文章
