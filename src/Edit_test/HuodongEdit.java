...
public class HuodongEdit implements TestInfo {
	...
	public void huodong_delete(String username,String password,String filePath,String vedioPath) throws Exception {
		...
		title=driver.findElement(By.className("tbxz_tit_bt fl")).getText();
		//String a=title.replace(" ", "");
		//System.out.println(a);
		equals="活动主题："+activityTitle;
	...
	public boolean checkdata2(){
		if(title.indexOf(activityTitle)!=-1){
			return true;
		}
		else{
			return false;
