...
public class  Fabugonggao{
  ...
  public  void publish_activity(String username,String password,String filePath,String vedioPath) throws Exception {	
	  ...
	  driver.findElement(By.partialLinkText("公告")).click();
	    ...
	    driver.findElement(By.className("ke-content")).sendKeys("测试");
	    ...
	    driver.findElement(By.linkText("发 布")).click();
		 ...
		 driver.findElement(By.cssSelector("span.ke-dialog-icon-close")).click();
		 ...
		 driver.switchTo().frame(driver.findElement(By.className("ke-edit-iframe")));
			...
			driver.findElement(By.className("ke-content")).sendKeys("发布公告的内容文字");
